...
import (
	...
	"thebestdeal.net/internal/validator"
)
...
// 	products, err := app.products.Latest()
// 	if err != nil {
...
// 	id, err := app.products.Insert(title, content, expires)
// 	if err != nil {
// 		app.serverError(w, err)
// 		return
// 	}

// 	http.Redirect(w, r, fmt.Sprintf("/product/view?id=%d", id), http.StatusSeeOther)
// }
...
// func (app *application) productCreatePost(w http.ResponseWriter, r *http.Request) {
// 	err := r.ParseForm()
// 	if err != nil {
...
// 	id, err := app.products.Insert(form.Title, form.Content, form.Expires)
// 	if err != nil {
// 		app.serverError(w, err)
// 		return
// 	}

// 	http.Redirect(w, r, fmt.Sprintf("/product/view/%d", id), http.StatusSeeOther)
// }
...
func (app *application) productCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), "flash", "Product successfully created!")
